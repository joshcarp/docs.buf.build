...
and each change is identifiable by a unique commit or tag. The collective set of
module versions is housed within a repository.
...
> See the [Usage](../bsr/usage.mdx#code-generation) section for a detailed
> example.
